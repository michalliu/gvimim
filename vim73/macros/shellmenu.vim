...
imenu Stmts.for	for  in dodoneki	kk0elli
imenu Stmts.case	case  in) ;;esacbki	k0elli
imenu Stmts.if	if   thenfiki	kk0elli
imenu Stmts.if-else	if   thenelsefiki	kki	kk0elli
imenu Stmts.elif	elif   thenki	kk0elli
imenu Stmts.while	while   dodoneki	kk0elli
